package com.colourfur.security.controller;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.colourfur.security.entity.vo.LoginVO;
import com.colourfur.security.entity.vo.ProfileEditVO;
import com.colourfur.security.entity.vo.RegisterVO;
...
import com.colourfur.security.utils.CustomPasswordEncoder;
...
public class UserController {
    ...
    public Result login(@RequestBody LoginVO loginVO, HttpServletResponse response){
        ...
        if (doaUser != null && CustomPasswordEncoder.matches(password, doaUser.getPassword())){
            TokenUtil.setToken(doaUser, response);
    ...
    public Result deleteUserWithToken(@ApiIgnore
                                      @RequestAttribute Long uid, HttpServletResponse response){
